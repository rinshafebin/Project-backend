...
urlpatterns = [
    path("profile/", AdvocateProfileView.as_view(), name="advocate-profile"),
    path("specializations/", SpecializationListCreate.as_view(), name="specializations"),
    path("teams/", AdvocateTeamListCreateView.as_view(), name="advocate-teams"),
    path("teams/<int:pk>/", AdvocateTeamDetailView.as_view(), name="advocate-team-detail"),
]
