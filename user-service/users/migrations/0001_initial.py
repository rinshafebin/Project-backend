    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'Client'), ('advocate', 'Advocate'), ('admin', 'Admin')], max_length=20)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('mfa_enabled', models.BooleanField(default=False)),
                ('mfa_type', models.CharField(blank=True, choices=[('TOTP', 'TOTP'), ('EMAIL', 'EMAIL')], max_length=10, null=True)),
