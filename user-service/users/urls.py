...
from .views import (
    ClientRegisterView, AdvocateRegisterView, LoginView,
    ForgetPasswordView, ResetPasswordView, ValidateTokenView
)

urlpatterns = [
    path("register/client/", ClientRegisterView.as_view(), name="register-client"),
    path("register/advocate/", AdvocateRegisterView.as_view(), name="register-advocate"),
    path("login/", LoginView.as_view(), name="login"),
